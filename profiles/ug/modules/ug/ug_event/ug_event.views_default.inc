...
/**
 * @file
 * ug_event.views_default.inc
 */

/**
 * Implements hook_views_default_views().
 */
function ug_event_views_default_views() {
  $export = array();

  $view = new view();
  $view->name = 'e1';
  $view->description = 'Provides a full listing of events, shown 10 at a time using pagination.';
  $view->tag = 'default';
  $view->base_table = 'node';
  $view->human_name = 'E1 - Listing page for multiple events';
  $view->core = 7;
  ...
  $handler->display->display_options['style_options']['row_class'] = 'media row';
  ...
  $handler->display->display_options['arguments']['tid']['title'] = 'Events related to %1';
  ...
  /* Display: Event Archives */
  $handler = $view->new_display('panel_pane', 'Event Archives', 'panel_pane_2');
  ...
  $handler->display->display_options['arguments']['date_argument']['title'] = 'Events from %1';
  ...
  $view = new view();
  $view->name = 'e2';
  $view->description = 'Provides all details for a single event.';
  $view->tag = 'default';
  $view->base_table = 'node';
  $view->human_name = 'E2 - Detail view for single event';
  $view->core = 7;
  $view->api_version = '3.0';
  $view->disabled = FALSE; /* Edit this to true to make a default view disabled initially */
  ...
  /* Field: Content: Feature image caption */
  $handler->display->display_options['fields']['field_event_image_caption']['id'] = 'field_event_image_caption';
  $handler->display->display_options['fields']['field_event_image_caption']['table'] = 'field_data_field_event_image_caption';
  $handler->display->display_options['fields']['field_event_image_caption']['field'] = 'field_event_image_caption';
  $handler->display->display_options['fields']['field_event_image_caption']['label'] = '';
  $handler->display->display_options['fields']['field_event_image_caption']['element_label_colon'] = FALSE;
  /* Field: Content: File attachments */
  $handler->display->display_options['fields']['field_event_attachments']['id'] = 'field_event_attachments';
  $handler->display->display_options['fields']['field_event_attachments']['table'] = 'field_data_field_event_attachments';
  $handler->display->display_options['fields']['field_event_attachments']['field'] = 'field_event_attachments';
  $handler->display->display_options['fields']['field_event_attachments']['label'] = '';
  $handler->display->display_options['fields']['field_event_attachments']['element_label_colon'] = FALSE;
  $handler->display->display_options['fields']['field_event_attachments']['click_sort_column'] = 'fid';
  $handler->display->display_options['fields']['field_event_attachments']['type'] = 'file_table';
  $handler->display->display_options['fields']['field_event_attachments']['delta_offset'] = '0';
  ...
  $view = new view();
  $view->name = 'e3';
  $view->description = 'Provides a teaser listing of 5 upcoming event itmes.';
  $view->tag = 'default';
  $view->base_table = 'node';
  $view->human_name = 'E3 - Upcoming events teaser list';
  $view->core = 7;
  $view->api_version = '3.0';
  $view->disabled = FALSE; /* Edit this to true to make a default view disabled initially */
  ...
  $view = new view();
  $view->name = 'e5';
  $view->description = 'Allows users to find a list of events associated with a specific year and month.';
  $view->tag = 'default';
  $view->base_table = 'node';
  $view->human_name = 'E5 - Browse events by date';
  $view->core = 7;
  $view->api_version = '3.0';
  $view->disabled = FALSE; /* Edit this to true to make a default view disabled initially */
  ...
  $view->human_name = 'E6 - Find related events by keyword';
  $view->core = 7;
  $view->api_version = '3.0';
  $view->disabled = FALSE; /* Edit this to true to make a default view disabled initially */
  ...
  /* Display: Master */
  $handler = $view->new_display('default', 'Master', 'default');
  $handler->display->display_options['title'] = 'Find Related Events by Keyword';
  $handler->display->display_options['use_more_always'] = FALSE;
  $handler->display->display_options['access']['type'] = 'perm';
  $handler->display->display_options['cache']['type'] = 'none';
  $handler->display->display_options['query']['type'] = 'views_query';
  ...
  $handler->display->display_options['fields']['name']['alter']['path'] = 'events/[tid]';
  ...
  $handler->display->display_options['arguments']['field_event_date_value']['table'] = 'field_data_field_event_date';
  $handler->display->display_options['arguments']['field_event_date_value']['field'] = 'field_event_date_value';
  $handler->display->display_options['arguments']['field_event_date_value']['default_action'] = 'default';
  $handler->display->display_options['arguments']['field_event_date_value']['default_argument_type'] = 'date';
  $handler->display->display_options['arguments']['field_event_date_value']['summary']['number_of_records'] = '0';
  $handler->display->display_options['arguments']['field_event_date_value']['summary']['format'] = 'default_summary';
  $handler->display->display_options['arguments']['field_event_date_value']['summary_options']['items_per_page'] = '25';
  ...
  $handler->display->display_options['fields']['field_event_image_caption']['label'] = '';
  $handler->display->display_options['fields']['field_event_image_caption']['element_label_colon'] = FALSE;
  $handler->display->display_options['fields']['field_event_image_caption']['element_wrapper_type'] = 'div';
  $handler->display->display_options['fields']['field_event_image_caption']['element_wrapper_class'] = 'caption';
  $handler->display->display_options['fields']['field_event_image_caption']['element_default_classes'] = FALSE;
  /* Contextual filter: Content: Nid */
  $handler->display->display_options['arguments']['nid']['id'] = 'nid';
  $handler->display->display_options['arguments']['nid']['table'] = 'node';
  $handler->display->display_options['arguments']['nid']['field'] = 'nid';
  ...
  $handler->display->display_options['allow']['fields_override'] = 0;
  $handler->display->display_options['inherit_panels_path'] = '0';
  $export['event_month_list'] = $view;

  $view = new view();
  $view->name = 'event_multipart';
  $view->description = '';
  $view->tag = 'default';
  ...
  $handler->display->display_options['style_plugin'] = 'default';
  $handler->display->display_options['row_plugin'] = 'fields';
  /* Relationship: Field collection item: Entity with the Sections (field_event_multipart) */
  $handler->display->display_options['relationships']['field_event_multipart_node']['id'] = 'field_event_multipart_node';
  $handler->display->display_options['relationships']['field_event_multipart_node']['table'] = 'field_collection_item';
  $handler->display->display_options['relationships']['field_event_multipart_node']['field'] = 'field_event_multipart_node';
  $handler->display->display_options['relationships']['field_event_multipart_node']['required'] = TRUE;
  /* Relationship: Field collection item: Heading (field_event_heading) */
  $handler->display->display_options['relationships']['field_event_heading_tid']['id'] = 'field_event_heading_tid';
  $handler->display->display_options['relationships']['field_event_heading_tid']['table'] = 'field_data_field_event_heading';
  $handler->display->display_options['relationships']['field_event_heading_tid']['field'] = 'field_event_heading_tid';
  /* Field: Taxonomy term: Icon */
  $handler->display->display_options['fields']['field_glyphicon']['id'] = 'field_glyphicon';
  $handler->display->display_options['fields']['field_glyphicon']['table'] = 'field_data_field_glyphicon';
  $handler->display->display_options['fields']['field_glyphicon']['field'] = 'field_glyphicon';
  $handler->display->display_options['fields']['field_glyphicon']['relationship'] = 'field_event_heading_tid';
  $handler->display->display_options['fields']['field_glyphicon']['label'] = '';
  $handler->display->display_options['fields']['field_glyphicon']['exclude'] = TRUE;
  $handler->display->display_options['fields']['field_glyphicon']['alter']['alter_text'] = TRUE;
  $handler->display->display_options['fields']['field_glyphicon']['alter']['text'] = '<span class="glyphicon glyphicon-[field_glyphicon]"></span>';
  $handler->display->display_options['fields']['field_glyphicon']['element_label_colon'] = FALSE;
  /* Field: Field collection item: Heading */
  $handler->display->display_options['fields']['field_event_heading']['id'] = 'field_event_heading';
  $handler->display->display_options['fields']['field_event_heading']['table'] = 'field_data_field_event_heading';
  $handler->display->display_options['fields']['field_event_heading']['field'] = 'field_event_heading';
  $handler->display->display_options['fields']['field_event_heading']['label'] = '';
  $handler->display->display_options['fields']['field_event_heading']['alter']['alter_text'] = TRUE;
  $handler->display->display_options['fields']['field_event_heading']['alter']['text'] = '[field_glyphicon] [field_event_heading]';
  $handler->display->display_options['fields']['field_event_heading']['element_type'] = 'h2';
  $handler->display->display_options['fields']['field_event_heading']['element_label_colon'] = FALSE;
  $handler->display->display_options['fields']['field_event_heading']['element_default_classes'] = FALSE;
  $handler->display->display_options['fields']['field_event_heading']['type'] = 'taxonomy_term_reference_plain';
  /* Field: Field collection item: Content */
  $handler->display->display_options['fields']['field_event_content']['id'] = 'field_event_content';
  $handler->display->display_options['fields']['field_event_content']['table'] = 'field_data_field_event_content';
  $handler->display->display_options['fields']['field_event_content']['field'] = 'field_event_content';
  $handler->display->display_options['fields']['field_event_content']['label'] = '';
  $handler->display->display_options['fields']['field_event_content']['element_label_colon'] = FALSE;
  /* Contextual filter: Content: Nid */
  $handler->display->display_options['arguments']['nid']['id'] = 'nid';
  $handler->display->display_options['arguments']['nid']['table'] = 'node';
  $handler->display->display_options['arguments']['nid']['field'] = 'nid';
  $handler->display->display_options['arguments']['nid']['relationship'] = 'field_event_multipart_node';
  $handler->display->display_options['arguments']['nid']['default_action'] = 'not found';
  $handler->display->display_options['arguments']['nid']['default_argument_type'] = 'fixed';
  $handler->display->display_options['arguments']['nid']['summary']['number_of_records'] = '0';
  $handler->display->display_options['arguments']['nid']['summary']['format'] = 'default_summary';
